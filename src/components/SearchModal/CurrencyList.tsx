...
export function CurrencyRow({
  ...
  return (
    ...
    >
      ...
      <Column>
        <Text title={currency.name} fontWeight={500} fontFamily={'Montserrat'} fontSize={'16px'} color={theme.text1}>
          {currency.symbol}
        </Text>
        <TYPE.darkGray ml='0px' fontSize={'12px'} fontWeight={500} fontFamily={'Montserrat'} color={theme.text2}>
      ...
      <LightGreyCard padding='8px 12px' borderRadius='8px'>
        <RowBetween>
          <RowFixed>
            ...
            <TYPE.main ml='6px' fontSize='12px' color={theme.primary1}>

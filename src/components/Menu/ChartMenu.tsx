...
const StyledChartButton = styled.div<{ isActive?: boolean }>`
...
export function ChartMenu() {
  ...
  return (
    <div ref={node as any}>
      <StyledChartButton onClick={toggle} isActive={open} ref={setReferenceElement as any}>
        Charts
      </StyledChartButton>

      {open && (
        <Menu ref={setPopperElement as any} style={styles.popper} {...attributes.popper}>
          <MenuItem href='https://dexscreener.com/base/brownfi'>
            <div>

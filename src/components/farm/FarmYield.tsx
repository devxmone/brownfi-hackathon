...
import { DataCard, DataRow } from './styled';
            ...
            <AutoColumn justify={'stretch'}>
              <Heading>
                ...
                <TYPE.body fontWeight={500} margin={'5px'} fontSize={isMobile ? 16 : 20}>
                  ...
                  <span style={{ color: '#F25A3B' }}> {` ${primaryEmissionPerSecond?.currency.symbol || ''}`}</span>
              ...
              {secondaryEmissionPerSecond && secondaryEmissionPerSecond.greaterThan(0) && (
                <Heading>
                  ...
                  <TYPE.body fontWeight={500} margin={'5px'} fontSize={isMobile ? 16 : 20}>
                    ...
                    <span style={{ color: '#F25A3B' }}>{` ${secondaryEmissionPerSecond?.currency.symbol || ''}`}</span>
                    <span> / {emissionTimeframe === 'weekly' ? 'week' : 'day'}</span>
                  </TYPE.body>
                </Heading>
              )}

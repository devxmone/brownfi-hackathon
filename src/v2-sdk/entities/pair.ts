...
import { _997, _1000, FIVE, INIT_CODE_HASH, MINIMUM_LIQUIDITY, ONE, ZERO } from '../constants';
...
export class Pair {
  ...
  public getB(x: number, y: number, a: number): number {
    return (
      -(2 ** (1 / 3) * (3 * a ** 4 + 12 * a ** 3 * x + 18 * a ** 2 * x ** 2 + 12 * a * x ** 3 + 3 * x ** 4)) /
        (3 *
          (a + x) *
          (-27 * a ** 2 * x ** 3 * y -
            27 * a ** 2 * x * y ** 3 +
            Math.sqrt(
              (-27 * a ** 2 * x ** 3 * y -
                ...
                27 * x ** 3 * y ** 3) **
                2 +
                4 * (3 * a ** 4 + 12 * a ** 3 * x + 18 * a ** 2 * x ** 2 + 12 * a * x ** 3 + 3 * x ** 4) ** 3,
            ) -
            54 * a * x ** 4 * y -
            54 * a * x ** 2 * y ** 3 -
            27 * x ** 5 * y -

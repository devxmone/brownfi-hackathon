...
import { CardBGImage, CardNoise, CardSection, DataCard } from '../../components/farm/styled';
            ...
            <AutoColumn gap='md'>
              ...
              <RowBetween style={{ marginBottom: '1rem' }}>
                <TYPE.white fontSize={14}>
                  {`BrownFi LP tokens are required. Once you've added liquidity to the ${currencyA?.symbol}-${currencyB?.symbol} pool you can stake your liquidity tokens on this page.`}
                </TYPE.white>
              </RowBetween>
              <ButtonPrimary
                padding='8px'
            ...
            <CardSection>
              ...
              <AutoColumn gap='md'>
                ...
                <RowBetween style={{ alignItems: 'baseline' }}>
                  ...
                  <TYPE.white>
                    BrownFi-LP {currencyA?.symbol}-{currencyB?.symbol}
                  </TYPE.white>
                </RowBetween>
              </AutoColumn>
            </CardSection>
